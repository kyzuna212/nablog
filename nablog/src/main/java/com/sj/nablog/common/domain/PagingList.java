...
public class PagingList {
	...
	private float pgSize ; 	//한 페이지에 나오는 글 갯수
	...
	public void setPgSize(float pgSize) {
		this.pgSize = pgSize;
	}
	...
	/*시작페이지, 끝페이지, 현재페이지 계산*/
	public PagingList( int pg,  int totalSize, float pgSize) {
		/*
		...
		if(pgSize==9.0f) {
			...
			this. endPage = (int)( Math.ceil(pg/5.0) )*5 ;
	...
	public String toString() {
		return "PagingList [startPage=" + startPage + ", endPage=" + endPage + ", pg=" + pg + ", pgSize=" + pgSize
				+ ", totalSize=" + totalSize + ", realEndPage=" + realEndPage + ", prev=" + prev + ", next=" + next
				+ "]";
	}
