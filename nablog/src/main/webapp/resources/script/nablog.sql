...
CREATE TABLE REPLY(
    ...
    B_NO NUMBER, --참조원글 번호
    REPLY_LEVEL CHAR(1),  --1: 댓글 , 2:대댓글 ...
    REPLY_REF NUMBER, -- 참조 댓글 번호
    REPLY_SRT NUMBER,
...
COMMENT ON COLUMN REPLY.REPLY_LEVEL IS '댓글레벨';
...
--샘플 데이터
INSERT INTO REPLY VALUES ( SEQ_REPLY_REPLY_NO.NEXTVAL, 'admin11', '첫번째 댓글이에요', 'N', 12, 1, 1 , 1, SYSDATE, 'Y');
INSERT INTO REPLY VALUES ( SEQ_REPLY_REPLY_NO.NEXTVAL, 'admin11', '두번째 댓글이에요', 'N', 12, 2, 1 , 2, SYSDATE, 'Y');
INSERT INTO REPLY VALUES ( SEQ_REPLY_REPLY_NO.NEXTVAL, 'admin11', '세번째 댓글이에요', 'N', 12, 2, 2 , 1, SYSDATE, 'Y');
INSERT INTO REPLY VALUES ( SEQ_REPLY_REPLY_NO.NEXTVAL, 'admin11', '네번째 댓글이에요', 'N', 12, 1, 4 , 1, SYSDATE, 'Y');
INSERT INTO REPLY VALUES ( SEQ_REPLY_REPLY_NO.NEXTVAL, 'admin11', '다섯번째 댓글이에요', 'N', 12, 2, 4 , 2, SYSDATE, 'Y');
